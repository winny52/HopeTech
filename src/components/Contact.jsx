          ...
          <div>
            <form className="bg-gray-800 p-6 rounded-lg space-y-4">
              <div>
                ...
                <input className="w-full p-2 bg-gray-700 text-white rounded" type="text" id="name" />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1" htmlFor="email">Email</label>
                <input className="w-full p-2 bg-gray-700 text-white rounded" type="email" id="email" />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1" htmlFor="message">Message</label>
                <textarea className="w-full p-2 bg-gray-700 text-white rounded" id="message" rows="4"></textarea>
              </div>
