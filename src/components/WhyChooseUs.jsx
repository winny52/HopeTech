...
function WhyChooseUs() {
  return (
    <div className=" text-blue-500 rounded-2xl">
      <div className="container flex flex-col  mt-10 mx-auto py-12">
        <div className='m-10 flex items-center '>
          <section>
            <h2 className="text-4xl text-blue-700 font-semibold mb-8">Why Choose HopeTech?</h2>
            <p className=" w-3/4 text-xl">Choosing the right partner for your web design and development needs is crucial to the success of your project. At HopeTech, we understand that you have many options, and we strive to stand out from the competition by offering unparalleled service, expertise, and results.</p>
          </section>
          <img src='https://images.shiksha.com/mediadata/ugcDocuments/images/wordpressImages/2020_09_5-Best-Programming-Languages-to-Learn-for-Cybersecurity-Professionals-scaled.jpg' alt='' className='rounded-full w-96 h-96' />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Expert Team */}
          <div className="feature bg-gray-200 p-6 rounded-lg">
